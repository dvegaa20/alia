      ...
      <main className="grow flex items-center justify-center px-4 md:px-8 py-6 md:py-10">
        <div className="max-w-3xl w-full flex flex-col items-center text-center">
          ...
          <div className="max-w-xl">
            <span className="text-primary font-bold tracking-[0.2em] text-xs uppercase mb-2 md:mb-3 block">
              Error 404
            </span>
            ...
            <p className="text-sm md:text-base text-muted-foreground leading-relaxed mb-6 md:mb-8">
              No podemos encontrar la página u organización que buscas. Es posible que el enlace sea
              incorrecto o la información haya sido movida. Pero no te detengas, hay muchas causas
              esperando tu apoyo.
            </p>
          ...
          <div className="mt-10 md:mt-12 pt-6 md:pt-8 border-t border-border w-full max-w-md">
            ...
            <div className="flex flex-wrap justify-center gap-2">
              <Badge
                variant="secondary"
                className="px-3 py-1 text-[10px] md:text-xs rounded-full font-semibold"
              >
                Medio Ambiente
              </Badge>
              <Badge
