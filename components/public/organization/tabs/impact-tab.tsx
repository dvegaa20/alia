              ...
              <div className="relative">
                <div className="flex items-center gap-3 mb-6">
                  ...
                  <div>
                    ...
                    <p className="text-sm font-bold text-foreground">{milestone.category}</p>
                  </div>
                </div>
              ...
              {milestone.stats && (
                <div className="relative grid grid-cols-2 gap-4">
                  {milestone.stats.map((stat: any) => (
                    <div key={stat.label} className="bg-muted/50 dark:bg-muted/30 rounded-2xl p-5">
              ...
              <div className="flex items-center gap-4">
                <div className="w-12 h-12 rounded-full overflow-hidden border-2 border-white dark:border-zinc-800 shadow-md shrink-0">
                  <Image
                    src={
                      testimony.avatarUrl ||
                      `https://api.dicebear.com/9.x/adventurer/svg?seed=${encodeURIComponent(testimony.author)}`
                    }
                ...
                <div>
                  <p className="font-bold text-foreground text-sm">{testimony.author}</p>
                ...
                <CardContent className="p-7 flex flex-col items-center text-center gap-4">
                  ...
                  <div>
                    <div className="flex items-baseline justify-center gap-1.5">
                      <span className="text-3xl font-black text-foreground">{fact.value}</span>
                      <span className="text-base font-bold text-foreground">{fact.unit}</span>
                    </div>
