      ...
      <div className="max-w-360 mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10">
          {featuredOrgs.map((org) => (
            <Link key={org.id} href={`/directory/${org.slug}`} className="block h-full">
              <Card
                className="group relative bg-card rounded-2xl overflow-hidden transition-all duration-500 hover:-translate-y-2 border-none ring-0 py-0 gap-0 h-full"
              >
                {/* Cover Image */}
