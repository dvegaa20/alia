...
export async function CategoryCarousel({ categorySlug, categoryName, categoryDescription }: CategoryCarouselProps) {
  ...
  return (
    <Feature
      ...
      description={categoryDescription || "Explora las organizaciones que están haciendo la diferencia en esta categoría."}
      items={items}
    />
  );
}
