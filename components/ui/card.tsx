...
function Card({
  ...
  return (
    <div
      data-slot="card"
      data-size={size}
      className={cn("ring-foreground/10 bg-slate-50/40 dark:bg-zinc-900/20 text-card-foreground gap-6 overflow-hidden rounded-2xl py-6 text-sm ring-1 has-[>img:first-child]:pt-0 data-[size=sm]:gap-4 data-[size=sm]:py-4 *:[img:first-child]:rounded-t-xl *:[img:last-child]:rounded-b-xl group/card flex flex-col", className)}
      {...props}
    />
  )
}
